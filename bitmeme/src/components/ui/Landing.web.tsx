...
export default function Landing({
  ...
  return (
    <>
      <Head>
        <title>BitMeme – AI Meme Generator & Bitcoin Tipping</title>
        <meta name="description" content="Create viral memes with AI and tip with Bitcoin, Solana, or STX. BitMeme is the ultimate meme generator and tipping app." />
        <meta property="og:title" content="BitMeme – AI Meme Generator & Bitcoin Tipping" />
        <meta property="og:description" content="Create viral memes with AI and tip with Bitcoin, Solana, or STX. BitMeme is the ultimate meme generator and tipping app." />
